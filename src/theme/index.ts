...
export function makeCategoryColors(colors: ColorScheme): Record<string, string> {
  return {
...
export const CategoryColors: Record<string, string> = makeCategoryColors(DarkColors);
